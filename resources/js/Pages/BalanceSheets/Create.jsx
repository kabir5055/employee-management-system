...
export default function Create({ auth, employees, canViewAllEmployees }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        employee_id: canViewAllEmployees ? '' : auth.user.id,
    ...
    return (
        ...
        >
            <Head title="Create Balance Sheet" />
                            ...
                            {canViewAllEmployees ? (
                                ...
                                <div>
                                    ...
                                    <div className="w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-xl text-gray-600">
                                        {auth.user.name} (Your Balance Sheet)
                                    </div>
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="0.00"
                                        step="0.01"
                                        className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
                                        readOnly
                                    />
                                </div>
                                {errors.total_amount && (
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20">
                        <div className="flex items-center justify-end space-x-4">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-medium rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:transform-none"
                            >
                                {processing ? (
                                    <>
