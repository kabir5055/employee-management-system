...
export default function Create({ departments, positions, districts }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const loadingToast = showToast.loading('Creating employee information...');

        post(route('personal-info.store'), {
            onSuccess: () => {
                showToast.dismiss(loadingToast);
                showToast.success('Employee information created successfully!');
            },
            onError: () => {
                showToast.dismiss(loadingToast);
                if (Object.keys(errors).length > 0) {
                    ...
                    showToast.error('Failed to create employee information');
                }
            }
        });
    };
    ...
    return (
        ...
        >
            <Head title="Add Employee Information" />
