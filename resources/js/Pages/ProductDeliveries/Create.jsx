...
export default function Create({ auth, products, employees }) {
    ...
    useEffect(() => {
        if (data.product_id && products) {
            ...
            if (product && !data.unit_price) {
                setData('unit_price', product.unit_price || '');
            }
        }
    }, [data.product_id]);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-lg font-bold text-gray-800">
                                    {data.delivery_date ? new Date(data.delivery_date).toLocaleDateString() : 'Select Date'}
                                </p>
                            </div>
                        </div>
                    </div>
