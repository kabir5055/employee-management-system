...
export default function Edit({ user, departments, positions }) {
    ...
    const handleSubmit = (e) => {
        ...
        const loadingToast = showToast.loading('Updating user...');

        // Use post method for file uploads with _method: PATCH
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    <ImageUpload
                                        label="Profile Photo"
                                        name="image"
                                        value={user.image_path ? `/storage/${user.image_path}` : null}
